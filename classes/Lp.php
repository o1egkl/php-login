    ...
    public function doLpList()
    {
    	if ($handle = opendir('LP')) {
    		while (false !== ($entry = readdir($handle))){
    			if ($entry != "." && $entry != "..") {
    				echo '<li><a href="edit.php?title='.$entry.'">'.$entry.'</a>&nbsp;<a href="stats.php?page='.substr($entry,0,strpos($entry,'.txt')).'">Stats</a>&nbsp;<a href="https://dry-fjord-6400.herokuapp.com/'.substr($entry,0,strpos($entry,'.txt')).'">View LP</a></li>';
    			}	
    		}
