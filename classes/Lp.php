    ...
    public function doLpList()
    {
    	if ($handle = opendir('LP')) {
    		while (false !== ($entry = readdir($handle))){
    			...
    			if ($entry != "." && $entry != "..") {
    				echo '<li style="width:70%;"><span style="display:inline-block;width:60%;"><a href="edit.php?title='.$entry.'">'.$pageName.'</a></span>&nbsp;<a href="stats.php?page='.$pageName.'">Stats</a>&nbsp;<a href="https://dry-fjord-6400.herokuapp.com/'.$pageName.'" target="new">View LP</a></li>';
    			}	
    		}
